...
export const CHANNEL_INSTRUCTIONS = [
  ...
  'at the top level. Every comment you post begins with the prefix that event gives you,',
  'written exactly as shown: it is how the channel knows a reply is its own.',
  '',
